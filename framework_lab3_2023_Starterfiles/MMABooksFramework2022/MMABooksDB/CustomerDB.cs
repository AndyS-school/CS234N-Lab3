...
namespace MMABooksDB
{
    public class CustomerDB : DBBase, IReadDB, IWriteDB
    {
        ...
        public bool Delete(IBaseProps p)
        {
            ...
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add("CustomerID", DBDbType.VarChar);
            command.Parameters.Add("conCurrId", DBDbType.Int32);
            command.Parameters["Name"].Value = props.Name;
            command.Parameters["Address"].Value = props.Name;
            command.Parameters["City"].Value = props.Name;
            command.Parameters["State"].Value = props.Name;
            command.Parameters["ZipCode"].Value = props.Name;
